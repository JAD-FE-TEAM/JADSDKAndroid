...
public class NSplashAdActivity extends BaseActivity {
    ...
    public static void startActivity(Activity activity, JADSlot slot, int typeIndex) {
    ...
    private void loadAdAndShow() {
        ...
        mJADNative.loadAd(new JADNativeLoadListener() {
            ...
            public void onLoadSuccess() {
                ...
                } else if (mEventInteractionType == JADSlot.EventInteractionType.EVENT_INTERACTION_TYPE_SHAKE) { //
                    // 摇一摇交互，使用SDk提供的摇一摇组件
                    mSplashContainer.removeAllViews();
                    adView.setLayoutParams(lp);
    ...
    private View inflateSplashView(JADNative nativeAd) {
        ...
        if (nativeAd != null
            ...
            mEventInteractionType = nativeAd.getDataList().get(0).getEventInteractionType();
            ImageLoader.loadImage(NSplashAdActivity.this,
                    nativeAd.getDataList().get(0).getImageUrls().get(0), imageView, true);
        }
        ...
        } else if (mEventInteractionType == JADSlot.EventInteractionType.EVENT_INTERACTION_TYPE_NORMAL) {
