...
public class ESplashMultiRequestActivity extends BaseActivity {
    ...
    private void collectAds(JADSplash splash, View adView) {
        Logger.d("【splash】 collectAds：【" + splash.hashCode() + ", " + adView.hashCode() + "】");
    ...
    private void showNextAd() {
        ...
        if (entries.hasNext()) {
            ...
            Logger.d("【splash】 show current ad ：【" + (mCurrentSplash != null ?
    ...
    private void loadAdAndShow(String slotID) {
        ...
        JADSlot slot = new JADSlot.Builder()
                ...
                //广告加载容忍时间。如果设定的时间内仍然没有加载到广告，则判断加载失败
        ...
        Logger.d("【splash】 init hashCode: " + splash.hashCode());
        //Step3: 加载广告
