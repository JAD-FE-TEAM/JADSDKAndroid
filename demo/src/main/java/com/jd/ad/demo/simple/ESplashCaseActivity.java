...
public class ESplashCaseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_simple_e_splash_ad_activity);
        mSplashAdContainer = findViewById(R.id.ad_container);


        //判断是否在主线程
        if (ThreadChooseUtils.isMainThread(ESplashCaseActivity.this)) {
            loadAdAndShow();
        } else {
