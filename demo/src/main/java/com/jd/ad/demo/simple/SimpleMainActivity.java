...
public class SimpleMainActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        bindButton(inflater, R.mipmap.ad_banner_ic, "模板-横幅", EBannerCaseActivity.class, true);
        bindButton(inflater, R.mipmap.ad_interstitial_ic, "模板-插屏", EInterstitialCaseActivity.class, true);
        bindItemHead(inflater, "自渲染广告");
        bindButton(inflater, R.mipmap.ad_splash_ic, "自渲染-开屏", NSplashCaseActivity.class, true);
        bindButton(inflater, R.mipmap.ad_feed_ic, "自渲染-信息流", NFeedCaseActivity.class, true);
        bindButton(inflater, R.mipmap.ad_banner_ic, "自渲染-横幅", NBannerCaseActivity.class, true);
        bindButton(inflater, R.mipmap.ad_interstitial_ic, "自渲染-插屏", NInterstitialCaseActivity.class, true);
