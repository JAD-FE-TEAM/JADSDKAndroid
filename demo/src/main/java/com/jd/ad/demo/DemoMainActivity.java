...
import com.jd.ad.demo.expressad.preload.EPreloadAdActivity;
import com.jd.ad.demo.expressad.preload.EPreloadAdManagerActivity;
...
import com.jd.ad.demo.simple.SimpleMainActivity;
...
public class DemoMainActivity extends BasePermissionActivity {
    ...
    private void initView() {
        ...
        bindButton(inflater, R.mipmap.ad_feed_ic, "信息流", EFeedManagerActivity.class, true);
        bindButton(inflater, R.mipmap.ad_splash_ic, "模版广告预加载", EPreloadAdActivity.class, false);
        ...
        bindItemHead(inflater, "简版");
        bindButton(inflater, R.mipmap.ad_feed_ic, "简版入口", SimpleMainActivity.class, true);
